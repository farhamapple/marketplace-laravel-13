...
return [
    ...
    'info' => [
        ...
        'description' => 'API untuk manajemen customer pada Marketplace Laravel 13. Mendukung autentikasi Sanctum, CRUD customer, pencarian, filter, sorting, dan paginasi.',
    ],
