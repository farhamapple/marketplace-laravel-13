...
<div class="flex min-h-[calc(100dvh-3.5rem)] items-center justify-center px-6 py-12">
    <div class="w-full max-w-sm">
        <div class="mb-8 text-center">
            <h1 class="font-display text-[clamp(1.75rem,4vw,2rem)] font-bold tracking-[-0.03em]">Create an account</h1>
            <p class="mt-2 text-sm text-text-secondary">Join the Genesis community</p>
        </div>
        ...
        <form method="POST" action="{{ url('/register') }}" class="space-y-5">
            ...
            <div>
                <label for="name" class="mb-1.5 block text-sm font-medium text-text-primary">Name</label>
                <input
                    type="text"
                    id="name"
                    name="name"
            ...
            <div>
                <label for="password_confirmation" class="mb-1.5 block text-sm font-medium text-text-primary">Confirm password</label>
                <input
                    type="password"
        ...
        <p class="mt-6 text-center text-sm text-text-secondary">
            ...
            <a href="{{ url('/login') }}" class="font-medium text-primary hover:text-primary-hover transition-colors">Log in</a>
        </p>
    </div>
</div>
@endsection
